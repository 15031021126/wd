 ...
 * */public class HomeJkzxFour extends BaseFragment<IhomeModelImpl, IhomePresenterImpl> implements IhomeContract.IhomeView {
    @BindView(R.id.jkzx_four_recy)
    XRecyclerView jkzxFourRecy;
...
//查询内容
        presenter.requestJkzxContent("4", "1", "5");
        jkzxFourRecy.setPullRefreshEnabled(false);
        jkzxFourRecy.setLayoutManager(new LinearLayoutManager(getActivity()));
        //添加尾布局
        addFootView();
    }
    ...
    private void addFootView() {
        ...
        jkzxFourRecy.setFootView(textView);
    ...
    protected int bindlayout() {
        return R.layout.home_jkzx_four;
    }
    ...
    public void showJkzxContent(Object obj) {
        ...
        if (heaithcontent.getResult().size() != 0) {
            ...
            if (resultBeans.size() != 0) {
                ...
                jkzxFourRecy.setAdapter(recyAdpter);
            }
        } else {
