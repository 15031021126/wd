 ...
 * */public class HomeJkzxThree extends BaseFragment<IhomeModelImpl, IhomePresenterImpl> implements IhomeContract.IhomeView {
    @BindView(R.id.jkzx_three_recy)
    XRecyclerView jkzxThreeRecy;
    ...
    protected void iniData() {
        //查询内容
        presenter.requestJkzxContent("3", "1", "5");
        jkzxThreeRecy.setPullRefreshEnabled(false);
        jkzxThreeRecy.setLayoutManager(new LinearLayoutManager(getActivity()));
        //添加尾布局
        addFootView();
    }
    ...
    protected int bindlayout() {
        return R.layout.home_jkzx_three;
    }
    ...
    public void showJkzxContent(Object obj) {
        ...
        if (heaithcontent.getResult().size() != 0) {
            ...
            if (resultBeans.size() != 0) {
                ...
                jkzxThreeRecy.setAdapter(recyAdpter);
            }
        } else {
