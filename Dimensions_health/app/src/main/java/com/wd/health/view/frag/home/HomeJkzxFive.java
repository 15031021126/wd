 ...
 * */public class HomeJkzxFive extends BaseFragment<IhomeModelImpl, IhomePresenterImpl> implements IhomeContract.IhomeView {

    @BindView(R.id.jkzx_five_recy)
    XRecyclerView jkzxFiveRecy;
    Unbinder unbinder;
...
//查询内容
        presenter.requestJkzxContent("5", "1", "5");
        jkzxFiveRecy.setPullRefreshEnabled(false);
        jkzxFiveRecy.setLayoutManager(new LinearLayoutManager(getActivity()));
        //添加尾布局
        addFootView();
    }
    ...
    protected int bindlayout() {
        return R.layout.home_jkzx_five;
    }
    ...
    public void showJkzxContent(Object obj) {
        ...
        if (heaithcontent.getResult().size() != 0) {
            ...
            if (resultBeans.size() != 0) {
                ...
                jkzxFiveRecy.setAdapter(recyAdpter);
            }
        } else {
